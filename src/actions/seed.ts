...
const ACCOUNT_ID = "a03b959b-4c01-4cda-b7ac-3ce17b1e08a8";
const USER_ID = "84e76066-e297-4ec4-b6ab-9774236be1ad";
...
export async function seedTransactions() {
  try {
    ...
    //tx is just like prisma 
    //$transaction is a prisma feature not model
